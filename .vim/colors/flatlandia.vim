...
hi PreCondit guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi Include guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi NonText guifg=#2d3033 guibg=#2d3033 guisp=#2d3033 gui=NONE ctermfg=237 ctermbg=NONE cterm=NONE
hi VertSplit guifg=#2d3033 guibg=#2d3033 guisp=#2d3033 gui=NONE ctermfg=237 ctermbg=237 cterm=NONE
"hi TabLineSel -- no settings --
hi LineNr guifg=#515253 guibg=#2c2f31 guisp=#2c2f31 gui=NONE ctermfg=255 ctermbg=237 cterm=NONE
...
hi PMenuSel guifg=#ffffff guibg=#3498DB guisp=#822098f gui=bold ctermfg=237 ctermbg=150 cterm=NONE
hi PMenu guifg=#949ba1 guibg=#303336 guisp=#2c2f34 gui=NONE ctermfg=245 ctermbg=237 cterm=NONE
hi PMenuThumb guifg=#822098f guibg=#4c4f54 guisp=#4c4f54 gui=NONE ctermfg=245 ctermbg=237 cterm=NONE
...
hi Conditional guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi Normal guifg=#e0e0e0 guibg=#26292c guisp=#26292c gui=NONE ctermfg=255 ctermbg=NONE cterm=NONE
...
hi Statement guifg=#f6f080 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi Operator guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi Define guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi Function guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE
"hi FoldColumn -- no settings --
hi PreProc guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi Keyword guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi MatchParen guifg=#26292c guibg=#fa9a4b guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=underline
"hi LocalVariable -- no settings --
hi Repeat guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE
"hi SpellBad -- no settings --
"hi CTagsClass -- no settings --

hi Directory guifg=#2098d8a guibg=#26292c guisp=#2d3033 gui=NONE ctermfg=237 ctermbg=237 cterm=NONE
hi Structure guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE
hi Macro guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi cssfunctionname guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi erubycomment guifg=#798188 guibg=NONE guisp=NONE gui=NONE ctermfg=66 ctermbg=NONE cterm=NONE
hi rubyclass guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi rubyrailsarmethod guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi htmlspecialchar guifg=#f1e94b guibg=NONE guisp=NONE gui=NONE ctermfg=227 ctermbg=NONE cterm=NONE
hi rubyexception guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi rubyglobalvariable guifg=#fb9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi htmltagname guifg=#b7d877 guibg=NONE guisp=NONE gui=NONE ctermfg=150 ctermbg=NONE cterm=NONE
hi rubyblockparameter guifg=#fb9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi erubyrailsmethod guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi javascriptrailsfunction guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
"hi javascriptbraces -- no settings --
hi rubyregexpdelimiter guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi rubyrailsmethod guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
"hi erubydelimiter -- no settings --
hi rubypseudovariable guifg=#fb9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi rubyrailsarassociationmethod guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi rubyrailsrendermethod guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi rubyinstancevariable guifg=#fb9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
"hi rubyinterpolationdelimiter -- no settings --
hi rubyclassvariable guifg=#fb9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi htmltag guifg=#b7d877 guibg=NONE guisp=NONE gui=NONE ctermfg=150 ctermbg=NONE cterm=NONE
hi rubycontrol guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi yamlalias guifg=#fb9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi yamlanchor guifg=#fb9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi rubyregexp guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi rubysymbol guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=150 ctermbg=NONE cterm=NONE
hi cssurl guifg=#fb9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
hi rubyinclude guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
hi rubyoperator guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=209 ctermbg=NONE cterm=NONE
...
" NerdTree
hi Directory guifg=#2098d8a guibg=#26292c guisp=#2d3033 gui=NONE ctermfg=255 ctermbg=236 cterm=NONE
